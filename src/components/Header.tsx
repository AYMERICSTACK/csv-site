          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              ...
              className={[
                ...
                transparentMode
                  ? "border border-white/20 bg-white/10 text-white backdrop-blur-sm hover:bg-white/15"
                  : "bg-csv-black text-white hover:opacity-90",
              ].join(" ")}
            >
              Inscriptions
            </Link>
      ...
      {open && (
        <div className="md:hidden">
          <button
            ...
            onClick={() => setOpen(false)}
          />
          <div className="fixed right-0 top-0 z-50 h-full w-[85%] max-w-sm border-l border-neutral-200 bg-white p-4 shadow-xl">
            ...
            <div className="mt-4 flex flex-col gap-2">
              ...
              <Link
                href="/admin/matchs"
                className="rounded-xl border border-neutral-300 px-3 py-3 text-center text-sm font-semibold text-neutral-900 hover:bg-neutral-50"
                onClick={() => setOpen(false)}
              >
                Admin
              </Link>
              ...
              <Link
                href="/inscriptions"
                className="mt-2 rounded-xl bg-csv-black px-3 py-3 text-center text-sm font-semibold text-white hover:opacity-90"
                onClick={() => setOpen(false)}
              >
                Inscriptions
              </Link>
