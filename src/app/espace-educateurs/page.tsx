...
async function requireEducateursAccess() {
...
export default async function EspaceEducateursPage() {
  const session = await requireEducateursAccess();
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 text-base leading-relaxed text-neutral-700 md:text-lg">
              Rassemble les informations utiles aux éducateurs et à
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-3">
          <div className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm lg:col-span-2">
            ...
            <p className="mt-2 text-sm leading-relaxed text-neutral-700">
              Cette base pourra accueillir les suivis, informations sportives et
              outils internes liés aux équipes.
            </p>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-2xl border border-neutral-200 bg-neutral-50 p-5">
                ...
                <p className="mt-2 text-sm text-neutral-600">
                  Structurer les entraînements et suivis sportifs.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-neutral-200 bg-neutral-50 p-5">
                ...
                <p className="mt-2 text-sm text-neutral-600">
                  Centraliser les infos utiles pour l’encadrement.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-neutral-200 bg-neutral-50 p-5">
                ...
                <p className="mt-2 text-sm text-neutral-600">
                  Documents, suivi équipes et outils éducateurs.
                </p>
              </div>
            </div>
          </div>
