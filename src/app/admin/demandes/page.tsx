                        ...
                        <div className="flex flex-wrap gap-3">
                          <form action={activateUser}>
                            <input
                              ...
                              value={user.id}
                            />
                            <FormSubmitButton idleLabel="Activer" pendingLabel="Activation…" successLabel="Activé ✓" loadingTitle="Activation en cours" successTitle="Compte activé" icon={<CheckCircle2 size={14} />} className="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-emerald-700 disabled:cursor-wait disabled:opacity-70" />
                          </form>
                          ...
                          <form action={deletePendingUser}>
                            <input
                              ...
                              value={user.id}
                            />
                            <FormSubmitButton idleLabel="Supprimer" pendingLabel="Suppression…" successLabel="Supprimé ✓" loadingTitle="Suppression en cours" successTitle="Suppression validée" icon={<Trash2 size={14} />} className="inline-flex items-center justify-center gap-2 rounded-xl border border-red-200 bg-white px-4 py-2 text-sm font-semibold text-red-600 transition hover:bg-red-50 disabled:cursor-wait disabled:opacity-70" />
                          </form>
                        </div>
                      </div>
                    </article>
